const getOrCreateTooltip = (chart) => {
  ...
  const externalTooltipHandler = (context) => {
    ...
    //         return {
    //             backgroundColor: 'rgba(212, 237, 191, 1)',
    //             borderWidth: 2,
    //             borderDash: [2, 2],
    //             borderRadius: 2,
    //             caretSize: 10,
    ...
    //         count_employe = 'Сотрудники ' +employeValue3[context.dataIndex].length + '. Пропуски ' + context.formattedValue
